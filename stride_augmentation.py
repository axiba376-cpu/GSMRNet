...
if __name__ == '__main__':
    img_path = r"F:\hzl3\UP-CrackNet-main\dataset\crack500_train\train\a\20160222_081011_0.png"
    ...
    cv.imshow('mask', np.reshape(mask1, (256, 256, 3)))
