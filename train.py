...
data_dir = './datasets/crack500_train/'
model_dir = './saved-model_crack500/'
...
for epoch in range(params.num_epochs):
    ...
    for i, (input, target, mask) in enumerate(train_data_loader):
        ...
        elif loss_L1_SSIM_Style == True:
            loss_SSIM = 1 - ssim(gen_image, y_)
            gen_style_loss = style_loss(gen_image, y_) * 10
            l_rec = gen_style_loss + loss_SSIM + L1_loss(gen_image, y_)
